...
class Item(models.Model):
    ...
    seller = models.ForeignKey('Student', models.DO_NOTHING, db_column='seller')
    description = models.CharField(max_length=255, blank=True, null=True)
    status = models.CharField(max_length=255)
    buyer = models.ForeignKey('Student', models.DO_NOTHING, db_column='buyer', blank=True, null=True)
...
class Timestamp(models.Model):
    increment = models.AutoField(primary_key=True)
